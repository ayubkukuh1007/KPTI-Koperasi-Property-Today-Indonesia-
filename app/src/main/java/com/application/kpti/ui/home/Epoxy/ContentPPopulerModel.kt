...
@EpoxyModelClass(layout = R.layout.home_item_property_populer_horizontal)
abstract class ContentPPopulerModel : EpoxyModelWithHolder<ContentPPopulerModel.ItemPropertyPopulerHolder>() {
