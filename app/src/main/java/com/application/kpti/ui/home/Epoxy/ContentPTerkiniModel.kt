...
@EpoxyModelClass(layout = R.layout.home_item_property_terkini_vertical)
abstract class ContentPTerkiniModel : EpoxyModelWithHolder<ContentPTerkiniModel.ItemPropertyTerkiniHolder>() {
